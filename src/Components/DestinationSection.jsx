...
const DestinationSection = ({ spots }) => {
    ...
    return (
        <section className="mb-36 text-center px-8 py-24 rounded-xl bg-sky-100 relative">
            ...
            className="absolute -top-16 lg:-top-72 w-full -ml-8 -z-3"
        >
            <path
                fill="#e0f2fe"
                fillOpacity="1"
            ...
            <div className="relative py-16">
                ...
                <div className="mt-12 inline-block">
                    <Link
                        to="/allspots"
                        className="text-white font-medium px-4 py-2 rounded-xl bg-green-700 hover:bg-gray-100 hover:text-green-800 transition-all ease-linear text-lg flex items-center justify-center gap-3"
                    >
                        See All Spots <ArrowBigRight />
                    </Link>
                </div>
            </div>
        </section>
